...
class Jpdnc_Plugin_Loader {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $actions    The actions registered with WordPress to run when the filter is fired.
	 */
	protected $actions;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $filters    The filters registered with WordPress to run when the filter is fired.
	 */
	protected $filters;
